...
% Transitions Count
[features_train.h_tx, features_train.v_tx] = countTransitions(trainX_shaped);

% Split Ratio
[features_train.lrRatio, features_train.lrRatio] = SplitWeight(trainX_shaped);
...
% Transitions Count
[features_test.h_tx, features_test.v_tx] = countTransitions(testX_shaped);

% Split Ratio
[features_test.lrRatio, features_test.udRatio] = SplitWeight(testX_shaped);
